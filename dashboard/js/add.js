...
var sendOff = sendApi("https://api.hobitourstravel.com/Offer/add", newOffer,"POST");
sendOff.then((res)=>{
  console.log(img);
  // addImage("https://localhost:7181/Offer/img/" + res.data, img);
  addImage("https://api.hobitourstravel.com/Offer/img/" + res.data, img);
  // var inputFile = img;
  // var data = new FormData();
  // data.append("imgName", inputFile.files[0].name);
  // data.append("img", inputFile.files[0]);
  // console.log(inputFile.files[0]);
  // var offerimg = sendApi("https://api.hobitourstravel.com/Offer/img" + res.data, data,"PUT");
...
function manageDestinations() {
  ...
  var sendDest = sendApi("https://api.hobitourstravel.com/destination/add", newDest,"POST");
  sendDest.then((res)=>{
    console.log(img);
    // addImage("https://localhost:7181/Offer/img/" + res.data, img);
    addImage("https://api.hobitourstravel.com/destination/img/" + res.data, img);
    // var inputFile = img;
    // var data = new FormData();
    // data.append("imgName", inputFile.files[0].name);
    // data.append("img", inputFile.files[0]);
    // console.log(inputFile.files[0]);
    // var offerimg = sendApi("https://api.hobitourstravel.com/destination/img" + res.data, data,"PUT");
